...
use Modules\Filehosting\Models\FileVersion;
use Modules\Filehosting\Services\FileService;
use Modules\Filehosting\Services\VersionService;
...
class FileController extends Controller
{
    ...
    public function uploadView(Request $request)
    {
        ...
        $files = \Modules\Filehosting\Models\File::with(['owner', 'folder'])
            ->orderByDesc('created_at')
            ->paginate(20);
            
        $folders = \Modules\Filehosting\Models\Folder::with('files')
            ->withCount('files')
            ->orderBy('name')
            ->get();
    ...
    public function destroy(Request $request, int $id): JsonResponse
    {
        ...
        // For now, allow deletion if user uploaded the file or is admin
