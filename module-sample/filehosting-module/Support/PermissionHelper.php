...
namespace Modules\FileHosting\Support;

use Modules\FileHosting\Models\Folder;
use Modules\FileHosting\Models\File;
use Modules\FileHosting\Models\FolderPermission;
...
class PermissionHelper
{
    ...
    public static function canOnFile(
        ...
        if ((int)$file->user_id === (int)$user->id && static::roleAllows($user, 'file', $ownPermission)) {
            return true;
        }
