...
<div class="container-fluid mt-4">
    <h2 class="mb-4">File Hosting - Hover Preview</h2>
...
<!-- Global Preview Container (outside table) -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    triggers.forEach(trigger => {
        ...
        trigger.addEventListener('mouseleave', function() {
            ...
            // Clear sources to stop video/audio
            previewImg.src = '';
            previewPdf.src = '';
            previewVideo.src = '';
        });
    ...
    function positionPreview(e) {
        ...
        let top = e.clientY - 250; // Center vertically relative to mouse

        // Boundary checks
        if (left + 400 > window.innerWidth) {
            left = e.clientX - 420; // Show on left side
        }
        if (top < 0) top = 10;
