...
// Email Verification Routes (must be before Auth::routes)
Route::get('/verify-code', [VerificationCodeController::class, 'showVerifyForm'])->name('verify-code.form');
Route::post('/verify-code', [VerificationCodeController::class, 'verify'])->name('verify-code.verify');
Route::post('/resend-code', [VerificationCodeController::class, 'resend'])->name('verify-code.resend');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('settings')->middleware('can:manage settings')->group(function () {
        ...
        Route::get('/department-menus', [SettingController::class, 'departmentMenus'])->name('settings.departmentMenus');
        Route::post('/department-menus', [SettingController::class, 'updateDepartmentMenus'])->name('settings.department-menus.update');
    });
    ...
    Route::get('/site-management', [SiteManagementController::class, 'index'])
        ...
        Route::prefix('backup')->middleware('can:manage settings')->group(function () {
            ...
            Route::put('/dashboard/profiles/{id}', [DashboardController::class, 'updateProfile'])
                ->name('dashboard.profiles.update');
    ...
    Route::middleware(['auth'])->prefix('api/widgets')->name('widgets.')->group(function () {
        ...
        // Serve uploaded files through Laravel (bypass Apache permission issues)
